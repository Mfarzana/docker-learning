...
### Daemons 
**Daemons are background process** that run separately from the controlling terminal and just about always have the init process as a parent process ID.1 they typically handle things such as network requests, hardware activity, and other wait & watch type tasks.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTU3ODI4MjQsLTE0MDg4MjI2NDcsLT
